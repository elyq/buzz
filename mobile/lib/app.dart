...
class App extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // `app_badge_plus` ships no web implementation, so every call throws
    // MissingPluginException. This one runs from a `useEffect` on first build,
    // where the throw escapes and kills the app before its first frame. A
    // browser tab has no app-icon badge to set, so web simply carries none.
